...
public class DijkstraBruteTest
{
	...
	public void test()
	{
		...
		{
			HashMap<Integer,VertexDijkstra> shortestMap = Dijkstra.ComputeShortestPathBrute(testInput.adjacencyList, testInput.srcVertexId);
